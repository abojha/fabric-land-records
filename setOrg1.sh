...
export PATH=$PATH:$HOME/Desktop/blockchain/fabric-samples/bin

export FABRIC_CFG_PATH=$HOME/Desktop/blockchain/fabric-samples/config
...
export ORDERER_CA=$HOME/Desktop/blockchain/fabric-samples/test-network/organizations/ordererOrganizations/example.com/msp/tlscacerts/tlsca.example.com-cert.pem
